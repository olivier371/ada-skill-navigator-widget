 ...
 * Varianten: data-variant="risico" (AI-risicocalculator) of data-variant="salaris" (AI-salariscalculator).
...
(function () {
  ...
  var variant = (script.getAttribute("data-variant") || "").replace(/[^a-z]/g, "");
  var pages = { risico: "risico/", salaris: "salaris/" };
  iframe.src = base + (pages[variant] || "index.html");
  var titles = { risico: "AI-risicocalculator", salaris: "AI-salariscalculator" };
  iframe.title = (titles[variant] || "AI Skill Navigator") + " van Amsterdam Data Academy";
  iframe.loading = "lazy";
  ...
  var target = document.getElementById(script.getAttribute("data-target") || "ada-skill-navigator");
